...
function AlbumInvitation({ notification }: ComposedProps) {
  ...
  return (
    ...
    >
      ...
      <ListItemText
        primary={
          <span>Invitation from <b>{notification.creator}</b>:</span>
        }
        secondary={
          <>
            ...
            <span className={classes.actions}>
              <Button className={classes.decline} onClick={() => {}} variant="outlined" size="small">
                Decline
              </Button>
              <Button className={classes.accept} onClick={() => {}} variant="outlined" size="small">
                Accept
              </Button>
            </span>
          </>
